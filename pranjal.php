...
<body background="images/gallery11.jpg">
   <form id="form1" runat="server">
       ...
       <div class="container-fluid col-md-9">
           <div class="row">
               <div style="background-color:#4CAF50; margin-left:15px" class="well well-lg">
                   <h2 class="text"><strong>Welcom to Hotel Pranjal</strong></h2><hr />
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div id="carousel1" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="item"> <img class="img-responsive" src="images/22.jpg" alt="thumb"/>
              <div class="carousel-caption"></div>
            </div>
            <div class="item active"> <img class="img-responsive" src="images/33.jpg" alt="thumb"/>
              <div class="carousel-caption"> </div>
            </div>
            <div class="item"> <img class="img-responsive" src="images/44.jpg" alt="thumb" />
              <div class="carousel-caption"></div>
            </div>
          </div>
    ...
    <hr />
         ...
         <section class="text-justify">Hotel Pranjal is one the finest and reasonable place for dine in Delhi/NCR region. Well comfortable and hygienic place. 
...
<!--Details -->
       <div class="container-fluid col-md-3">
           ...
           <ul class="text">
<li>Hotel Pranjal, D-45, Netaji Subhas Place, D-Mall, New Delhi</li>
<li>Ph: +91 11 241004444 </li>
