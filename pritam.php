...
<body background="images/gallery11.jpg">
   <form id="form1" runat="server">
       ...
       <div class="container-fluid col-md-9">
           <div class="row">
               <div style="background-color:#4CAF50; margin-left:15px" class="well well-lg">
                   <h2 class="text"><strong>Welcom to Pritam Inn.</strong></h2><hr />
    ...
    <hr />
         ...
         <section class="text-justify">Pritam Inn is one the finest and reasonable place for dine in Delhi/NCR region. Well comfortable and hygienic place. 
...
<!--Details -->
       <div class="container-fluid col-md-3">
           ...
           <ul class="text">
<li>Pritam Inn, 321, Geeta Colony West, New Delhi</li>
<li>Ph: 886 100 4444 </li>
